...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Admin Details</div>
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<div class="card-title m-0">
												<h3 class="fw-bolder m-0">Admin Details</h3>
											</div>
											<!--end::Card title-->
											<!--begin::Action-->
											<a href="adminList.ad" class="btn btn-danger align-self-center">Admin List</a>
		...
		<div id="photo" style="margin:center">	
      		...
      		<div id="char1" style="float:right">
				<img class="mx-auto rounded-circle" height="350" width="350" src="${ at[0].adminChangeFile }${ at[0].adminChangeName }" alt="나와라" />
						...
						<div class="row mb-7">
							<!--begin::Label-->
							<label class="col-lg-4 fw-bold text-muted">Admin No.</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bolder fs-6 text-dark">[  ${a.aNo}  ]</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Row-->
						...
						<div class="row mb-7">
							<!--begin::Label-->
							<label class="col-lg-4 fw-bold text-muted">Grade No.</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8 fv-row">
								<span class="fw-bolder fs-6 text-dark">${a.aGno} . 일반관리자</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8 fv-row">
								<span class="fw-bolder fs-6 text-dark">${a.aName}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							<!--begin::Label-->
							<label class="col-lg-4 fw-bold text-muted">Admin ID
							<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="ID must be verified"></i></label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8 d-flex align-items-center">
								<span class="fw-bolder fs-6 me-2">${a.aId}</span>
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8">
								<a href="#" class="fw-bold fs-6 text-dark text-hover-primary">${a.aEmail}</a>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bolder fs-6 text-dark">Korea</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							<!--begin::Label-->
							<label class="col-lg-4 fw-bold text-muted">Hire Date</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bolder fs-6 text-dark">${a.aHireDate}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
