                ...
                <img src="resources/memberAdmin/assets/img/son3.jpg" alt="..." class="img-circle profile_img">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="resources/memberAdmin2/tables.html">관리자 조회</a>
                            ...
                            <a class="nav-link" href="sAdmin.ad">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">특수관리자</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">관리자조회</li>
                        </ol>
