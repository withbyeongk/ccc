...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Member Details</div>
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<div class="card-header cursor-pointer">
											...
											<!--end::Card title-->
											<!--begin::Action-->
											<a href="member.ad" class="btn btn-info align-self-center">Main</a>
											<!--end::Action-->
										</div>
										<!--begin::Card header-->
										<!--begin::Card body-->
		...
		<div id="photo" style="margin:center">	
      		...
      		<div id="char1" style="float:right">
				<img class="mx-auto rounded-circle" height="350" width="350" src="resources/memberAdmin/assets/img/member.png" alt="..." />
			</div>	
									<div class="adminInfo">
											
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">아이디 [회원번호]</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-dark">${m.memberId } [회원번호:${m.memberNo }]</span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Row-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">이름(성별)</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<span class="fw-bolder fs-6 text-dark">${m.memberName } (${m.memberGender })</span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">회원등급 [포인트]
												<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i></label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 d-flex align-items-center">
													<span class="fw-bolder fs-6 me-2">${m.memberGradeNo }등급 [포인트: ${m.memberPoint }]</span>
											...
											<div class="row mb-7">
												...
												<!--begin::Col-->
												<div class="col-lg-8">
													<a href="#" class="fw-bolder fs-6 text-dark">${m.memberEmail }</a>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">전화번호
												<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Country of origination"></i></label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-dark">${m.memberPoint }</span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">주소</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-dark">${m.memberAddress }</span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-10">
												<!--begin::Label-->
												<label class="col-lg-4 fw-bold text-muted">회원가입일</label>
												<!--begin::Label-->
												<!--begin::Label-->
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-dark">${m.memberCreateDate }</span>
												</div>
		...
		<!--end::Scrolltop-->
		<!--end::Main-->
		<script>var hostUrl = "resources/profile/theme/dist/assets/";</script>
		<!--begin::Javascript-->
		<!--begin::Global Javascript Bundle(used by all pages)-->
		<script src="resources/profile/theme/dist/assets/plugins/global/plugins.bundle.js"></script>
		<script src="resources/profile/theme/dist/assets/js/scripts.bundle.js"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="resources/profile/theme/dist/assets/js/custom/widgets.js"></script>
