...
<body>
<!-- 
	참고페이지 : https://wogus789789.tistory.com/169
 -->
	<!-- layer popup content -->
	<div class="layerPopup" id="layer_popup" style="visibility: visible;">
	    <div class="layerBox">
<!-- 	        <h4 class="title">GOODS 공지사항</h4> -->
	        <div class="cont">
	            <p>
	            	<!-- 팝업용 이미지 폴더 따로 만들면 좋을듯 -->
					<img src="resources/goodsImg/popup/img02.gif" width=450px usemap="#popup" alt="event page">
	            </p>
	        </div>
				<form name="pop_form">
